    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Securely store your personal information. This data is encrypted in
          your browser and never visible to our servers.
        </p>
      </div>
      ...
      <VaultList query={getItemsQuery} getKey={handleGetKey} />
    </div>
  );
}
